...
sys.path.append('/home/user-1/Documents/project/3DUnetCNN-master/')
...
config["n_epochs"] = 20 # cutoff the training after this many epochs
...
config["second_model_file"] = os.path.abspath("tumor_segmentation_model_deeper.h5")
